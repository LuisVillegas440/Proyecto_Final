function generateQuestion() {
    ...
    const names = ['Juan', 'María', 'Pedro', 'Ana', 'Luis', 'Laura'];
    ...
    document.getElementById('question').textContent = `¿Quién es mayor, ${name1} de ${age1} años o ${name2} de ${age2} años?`;
...
function checkAnswer(isCorrect) {
    ...
    resultDiv.textContent = isCorrect ? '¡Correcto! El nombre mayor es el correcto.' : 'Incorrecto. El nombre mayor es el correcto.';
}
